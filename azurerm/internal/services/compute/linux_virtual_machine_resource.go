	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"dedicated_host_id": {
				Type:     schema.TypeString,
				Optional: true,
				ForceNew: true, // TODO: apparently not?!
...
func resourceLinuxVirtualMachineUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	// TODO: pull this out into a helper since it'll be reused by disk attachments
	...
	// TODO: can allow_extension_operation and provision_vm_agent be updated too?
	...
	if shouldDeallocate {
		...
		if err != nil {
			return fmt.Errorf("Error Deallocating to Linux Virtual Machine %q (Resource Group %q): %+v", id.Name, id.ResourceGroup, err)
		}
